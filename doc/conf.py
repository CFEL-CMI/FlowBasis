...
latex_documents = [
  ('index', 'docs.tex', 'Documentation', 'CFEL Controlled Molecule Imaging', 'manual'),
]
...
texinfo_documents = [
  ('index', 'docs', 'Documentation',
   'Controlled Molecule Imaging group', 'CMI template', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = 'CMI Python-project template'
epub_author = 'CFEL Controlled Molecule Imaging'
epub_publisher = 'CFEL Controlled Molecule Imaging'
epub_copyright = '(C) 2020 Jochen Küpper & CFEL Controlled Molecule Imaging'
